...
public:
	...
	void SetSurvivalEvent(NS::int32 nSurvivalID, NS::I64 uuid);
	NS::I64 GetSurvivalUuid() { return m_nSurvivalUuid; }
	NS::int32 SetSurvivalEventID() { return m_nSurvivalEventID; }
public:
	enum class MapType
	{
		None = 0,
...
private:
	...
	NS::int32 m_nSurvivalEventID{ 0 };
	NS::I64 m_nSurvivalUuid{ 0 };
