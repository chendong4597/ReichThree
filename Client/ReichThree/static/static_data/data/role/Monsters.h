...
public:
	...
	void setSurvivalUuid(NS::I64 surUuid) { m_nSurvivalUuid = surUuid; }
	NS::I64 getSurvivalUuid() { return m_nSurvivalUuid; }

	void setTowerDefenceUuid(NS::I64 surUuid) { m_nTowerUuid = surUuid; }
	NS::I64 getTowerDefenceUuid() { return m_nTowerUuid; }
...
public:
	...
	std::shared_ptr<Monster> getMonsterByTowerUuid(bzbee::I64 tUuid);
