...
public:
	...
	typedef std::map<NS::int32, NS::I64> GenbuffMap;
	typedef std::map<NS::int32, NS::I64> FoodbuffMap;
public:
	...
	NS::I64 getDolnateNum() { return m_nDonateNum; }	//贡献度
	NS::int32 getDolnateLv() { return m_nDonateLv; }	//爵位
	NS::I64 getGenbuff(int nGenIdx);
	NS::int32 GetFoodAddSpeed() { return m_foodAddSpeed; }
	...
	void setDolnateNum(NS::I64 nNum) { m_nDonateNum = nNum; }	//贡献度
	void setDolnateLv(NS::int32 nLv) { m_nDonateLv = nLv; }	//爵位

	void ClearGenBuff() { m_genBuf.clear(); }
	void addGenBuff(int nIdx, NS::I64 tmEnd);

	void ClearFoodBuff();
	void addFoodBuff(int nFoodItem, NS::I64 tmEnd);
	const FoodbuffMap& GetFoodBuff() { return m_foodBuff; }
	...
	void CaluDonateAttr(AttrMap& mapAttr);
	void CaluFoodAttr(AttrMap& mapAttr);
...
private:
	...
	NS::I64 m_nDonateNum{ 0 };	//贡献度
	NS::int32 m_nDonateLv{ 0 };	//爵位

	GenbuffMap m_genBuf;

	FoodbuffMap m_foodBuff;
	int        m_foodAddSpeed{ 0 };
