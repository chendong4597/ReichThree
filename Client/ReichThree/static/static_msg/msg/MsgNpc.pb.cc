...
const ::google::protobuf::Descriptor* MsgTradeNpcData_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  MsgTradeNpcData_reflection_ = NULL;
const ::google::protobuf::Descriptor* MsgTradeNpcAppearance_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  MsgTradeNpcAppearance_reflection_ = NULL;
...
void protobuf_AssignDesc_MsgNpc_2eproto() {
  ...
  MsgTradeNpcData_descriptor_ = file->message_type(9);
  static const int MsgTradeNpcData_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MsgTradeNpcData, tradeuuid_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MsgTradeNpcData, tradeiggid_),
  };
  MsgTradeNpcData_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      MsgTradeNpcData_descriptor_,
      MsgTradeNpcData::default_instance_,
      MsgTradeNpcData_offsets_,
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MsgTradeNpcData, _has_bits_[0]),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MsgTradeNpcData, _unknown_fields_),
      -1,
      ::google::protobuf::DescriptorPool::generated_pool(),
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(MsgTradeNpcData));
  MsgTradeNpcAppearance_descriptor_ = file->message_type(10);
  static const int MsgTradeNpcAppearance_offsets_[3] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MsgTradeNpcAppearance, msgtype_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MsgTradeNpcAppearance, npcselldata_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MsgTradeNpcAppearance, npcbuydata_),
  };
  MsgTradeNpcAppearance_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      MsgTradeNpcAppearance_descriptor_,
      MsgTradeNpcAppearance::default_instance_,
      MsgTradeNpcAppearance_offsets_,
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MsgTradeNpcAppearance, _has_bits_[0]),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MsgTradeNpcAppearance, _unknown_fields_),
      -1,
      ::google::protobuf::DescriptorPool::generated_pool(),
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(MsgTradeNpcAppearance));
}
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
    MsgTradeNpcData_descriptor_, &MsgTradeNpcData::default_instance());
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
    MsgTradeNpcAppearance_descriptor_, &MsgTradeNpcAppearance::default_instance());
}
...
void protobuf_ShutdownFile_MsgNpc_2eproto() {
  ...
  delete MsgTradeNpcData::default_instance_;
  delete MsgTradeNpcData_reflection_;
  delete MsgTradeNpcAppearance::default_instance_;
  delete MsgTradeNpcAppearance_reflection_;
}
...
void protobuf_AddDesc_MsgNpc_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\025.MsgPB.ServerBuffInfo\"8\n\017MsgTradeNpcDat"
    "a\022\021\n\ttradeUuid\030\001 \001(\003\022\022\n\ntradeIggId\030\002 \001(\003"
    "\"\254\001\n\025MsgTradeNpcAppearance\022:\n\007msgType\030\001 "
    "\001(\0162\017.MsgPB.EMsgType:\030_MSG_TRADE_NPC_APP"
    "EARACE\022+\n\013npcSellData\030\002 \003(\0132\026.MsgPB.MsgT"
    "radeNpcData\022*\n\nnpcBuyData\030\003 \003(\0132\026.MsgPB."
    "MsgTradeNpcData", 1695);
  ...
  MsgTradeNpcData::default_instance_ = new MsgTradeNpcData();
  MsgTradeNpcAppearance::default_instance_ = new MsgTradeNpcAppearance();
  ...
  MsgTradeNpcData::default_instance_->InitAsDefaultInstance();
  MsgTradeNpcAppearance::default_instance_->InitAsDefaultInstance();
...
#ifndef _MSC_VER
const int MsgTradeNpcData::kTradeUuidFieldNumber;
const int MsgTradeNpcData::kTradeIggIdFieldNumber;
#endif  // !_MSC_VER

MsgTradeNpcData::MsgTradeNpcData()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:MsgPB.MsgTradeNpcData)
}

void MsgTradeNpcData::InitAsDefaultInstance() {
}

MsgTradeNpcData::MsgTradeNpcData(const MsgTradeNpcData& from)
  : ::google::protobuf::Message() {
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:MsgPB.MsgTradeNpcData)
}

void MsgTradeNpcData::SharedCtor() {
  _cached_size_ = 0;
  tradeuuid_ = GOOGLE_LONGLONG(0);
  tradeiggid_ = GOOGLE_LONGLONG(0);
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
}

MsgTradeNpcData::~MsgTradeNpcData() {
  // @@protoc_insertion_point(destructor:MsgPB.MsgTradeNpcData)
  SharedDtor();
}

void MsgTradeNpcData::SharedDtor() {
  if (this != default_instance_) {
  }
}

void MsgTradeNpcData::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const ::google::protobuf::Descriptor* MsgTradeNpcData::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return MsgTradeNpcData_descriptor_;
}

const MsgTradeNpcData& MsgTradeNpcData::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_MsgNpc_2eproto();
  return *default_instance_;
}

MsgTradeNpcData* MsgTradeNpcData::default_instance_ = NULL;

MsgTradeNpcData* MsgTradeNpcData::New() const {
  return new MsgTradeNpcData;
}

void MsgTradeNpcData::Clear() {
#define OFFSET_OF_FIELD_(f) (reinterpret_cast<char*>(      \
  &reinterpret_cast<MsgTradeNpcData*>(16)->f) - \
   reinterpret_cast<char*>(16))
...
bool MsgTradeNpcData::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:MsgPB.MsgTradeNpcData)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      // optional int64 tradeUuid = 1;
      case 1: {
        if (tag == 8) {
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   ::google::protobuf::int64, ::google::protobuf::internal::WireFormatLite::TYPE_INT64>(
        ...
        if (input->ExpectTag(16)) goto parse_tradeIggId;
        break;
      }

      // optional int64 tradeIggId = 2;
      case 2: {
        if (tag == 16) {
         parse_tradeIggId:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
...
success:
  // @@protoc_insertion_point(parse_success:MsgPB.MsgTradeNpcData)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:MsgPB.MsgTradeNpcData)
  return false;
#undef DO_
}

void MsgTradeNpcData::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:MsgPB.MsgTradeNpcData)
  // optional int64 tradeUuid = 1;
  if (has_tradeuuid()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt64(1, this->tradeuuid(), output);
  }

  // optional int64 tradeIggId = 2;
  if (has_tradeiggid()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt64(2, this->tradeiggid(), output);
  }
  ...
  // @@protoc_insertion_point(serialize_end:MsgPB.MsgTradeNpcData)
}

::google::protobuf::uint8* MsgTradeNpcData::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:MsgPB.MsgTradeNpcData)
  // optional int64 tradeUuid = 1;
  if (has_tradeuuid()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt64ToArray(1, this->tradeuuid(), target);
  }

  // optional int64 tradeIggId = 2;
  if (has_tradeiggid()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt64ToArray(2, this->tradeiggid(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:MsgPB.MsgTradeNpcData)
  return target;
}

int MsgTradeNpcData::ByteSize() const {
  int total_size = 0;
...
void MsgTradeNpcData::MergeFrom(const ::google::protobuf::Message& from) {
  GOOGLE_CHECK_NE(&from, this);
  const MsgTradeNpcData* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const MsgTradeNpcData*>(
      &from);
  if (source == NULL) {
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
...
void MsgTradeNpcData::MergeFrom(const MsgTradeNpcData& from) {
  GOOGLE_CHECK_NE(&from, this);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_tradeuuid()) {
      set_tradeuuid(from.tradeuuid());
    }
...
void MsgTradeNpcData::CopyFrom(const ::google::protobuf::Message& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void MsgTradeNpcData::CopyFrom(const MsgTradeNpcData& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool MsgTradeNpcData::IsInitialized() const {

  return true;
}

void MsgTradeNpcData::Swap(MsgTradeNpcData* other) {
  if (other != this) {
    std::swap(tradeuuid_, other->tradeuuid_);
...
::google::protobuf::Metadata MsgTradeNpcData::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = MsgTradeNpcData_descriptor_;
  metadata.reflection = MsgTradeNpcData_reflection_;
  return metadata;
}
...
#ifndef _MSC_VER
const int MsgTradeNpcAppearance::kMsgTypeFieldNumber;
const int MsgTradeNpcAppearance::kNpcSellDataFieldNumber;
const int MsgTradeNpcAppearance::kNpcBuyDataFieldNumber;
#endif  // !_MSC_VER

MsgTradeNpcAppearance::MsgTradeNpcAppearance()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:MsgPB.MsgTradeNpcAppearance)
}

void MsgTradeNpcAppearance::InitAsDefaultInstance() {
}

MsgTradeNpcAppearance::MsgTradeNpcAppearance(const MsgTradeNpcAppearance& from)
  : ::google::protobuf::Message() {
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:MsgPB.MsgTradeNpcAppearance)
}

void MsgTradeNpcAppearance::SharedCtor() {
  _cached_size_ = 0;
  msgtype_ = 1569;
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
}
...
MsgTradeNpcAppearance::~MsgTradeNpcAppearance() {
  // @@protoc_insertion_point(destructor:MsgPB.MsgTradeNpcAppearance)
  SharedDtor();
}

void MsgTradeNpcAppearance::SharedDtor() {
  if (this != default_instance_) {
  }
}

void MsgTradeNpcAppearance::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const ::google::protobuf::Descriptor* MsgTradeNpcAppearance::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return MsgTradeNpcAppearance_descriptor_;
}

const MsgTradeNpcAppearance& MsgTradeNpcAppearance::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_MsgNpc_2eproto();
  return *default_instance_;
}

MsgTradeNpcAppearance* MsgTradeNpcAppearance::default_instance_ = NULL;

MsgTradeNpcAppearance* MsgTradeNpcAppearance::New() const {
  return new MsgTradeNpcAppearance;
}

void MsgTradeNpcAppearance::Clear() {
  msgtype_ = 1569;
  npcselldata_.Clear();
  npcbuydata_.Clear();
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
...
bool MsgTradeNpcAppearance::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:MsgPB.MsgTradeNpcAppearance)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      // optional .MsgPB.EMsgType msgType = 1 [default = _MSG_TRADE_NPC_APPEARACE];
      case 1: {
        if (tag == 8) {
          int value;
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
        ...
        if (input->ExpectTag(18)) goto parse_npcSellData;
        break;
      }

      // repeated .MsgPB.MsgTradeNpcData npcSellData = 2;
      case 2: {
        if (tag == 18) {
         parse_npcSellData:
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
                input, add_npcselldata()));
        } else {
          goto handle_unusual;
        }
        if (input->ExpectTag(18)) goto parse_npcSellData;
        if (input->ExpectTag(26)) goto parse_npcBuyData;
        break;
      }

      // repeated .MsgPB.MsgTradeNpcData npcBuyData = 3;
      case 3: {
        if (tag == 26) {
         parse_npcBuyData:
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
                input, add_npcbuydata()));
        } else {
          goto handle_unusual;
        }
        if (input->ExpectTag(26)) goto parse_npcBuyData;
...
success:
  // @@protoc_insertion_point(parse_success:MsgPB.MsgTradeNpcAppearance)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:MsgPB.MsgTradeNpcAppearance)
  return false;
#undef DO_
}

void MsgTradeNpcAppearance::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:MsgPB.MsgTradeNpcAppearance)
  // optional .MsgPB.EMsgType msgType = 1 [default = _MSG_TRADE_NPC_APPEARACE];
  if (has_msgtype()) {
    ::google::protobuf::internal::WireFormatLite::WriteEnum(
      1, this->msgtype(), output);
  ...
  // repeated .MsgPB.MsgTradeNpcData npcSellData = 2;
  for (int i = 0; i < this->npcselldata_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      2, this->npcselldata(i), output);
  }

  // repeated .MsgPB.MsgTradeNpcData npcBuyData = 3;
  for (int i = 0; i < this->npcbuydata_size(); i++) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      3, this->npcbuydata(i), output);
  }
  ...
  // @@protoc_insertion_point(serialize_end:MsgPB.MsgTradeNpcAppearance)
}

::google::protobuf::uint8* MsgTradeNpcAppearance::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:MsgPB.MsgTradeNpcAppearance)
  // optional .MsgPB.EMsgType msgType = 1 [default = _MSG_TRADE_NPC_APPEARACE];
  if (has_msgtype()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteEnumToArray(
      1, this->msgtype(), target);
  ...
  // @@protoc_insertion_point(serialize_to_array_end:MsgPB.MsgTradeNpcAppearance)
  return target;
}

int MsgTradeNpcAppearance::ByteSize() const {
  int total_size = 0;
  ...
  // repeated .MsgPB.MsgTradeNpcData npcSellData = 2;
  total_size += 1 * this->npcselldata_size();
  for (int i = 0; i < this->npcselldata_size(); i++) {
    total_size +=
      ::google::protobuf::internal::WireFormatLite::MessageSizeNoVirtual(
        this->npcselldata(i));
  ...
  // repeated .MsgPB.MsgTradeNpcData npcBuyData = 3;
  total_size += 1 * this->npcbuydata_size();
  for (int i = 0; i < this->npcbuydata_size(); i++) {
    total_size +=
      ::google::protobuf::internal::WireFormatLite::MessageSizeNoVirtual(
        this->npcbuydata(i));
...
void MsgTradeNpcAppearance::MergeFrom(const ::google::protobuf::Message& from) {
  GOOGLE_CHECK_NE(&from, this);
  const MsgTradeNpcAppearance* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const MsgTradeNpcAppearance*>(
      &from);
  if (source == NULL) {
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
...
void MsgTradeNpcAppearance::MergeFrom(const MsgTradeNpcAppearance& from) {
  GOOGLE_CHECK_NE(&from, this);
  npcselldata_.MergeFrom(from.npcselldata_);
  npcbuydata_.MergeFrom(from.npcbuydata_);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_msgtype()) {
      set_msgtype(from.msgtype());
    }
...
void MsgTradeNpcAppearance::CopyFrom(const ::google::protobuf::Message& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void MsgTradeNpcAppearance::CopyFrom(const MsgTradeNpcAppearance& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool MsgTradeNpcAppearance::IsInitialized() const {

  return true;
}

void MsgTradeNpcAppearance::Swap(MsgTradeNpcAppearance* other) {
  if (other != this) {
    std::swap(msgtype_, other->msgtype_);
    npcselldata_.Swap(&other->npcselldata_);
    npcbuydata_.Swap(&other->npcbuydata_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
    _unknown_fields_.Swap(&other->_unknown_fields_);
    std::swap(_cached_size_, other->_cached_size_);
  }
...
::google::protobuf::Metadata MsgTradeNpcAppearance::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = MsgTradeNpcAppearance_descriptor_;
  metadata.reflection = MsgTradeNpcAppearance_reflection_;
  return metadata;
}
