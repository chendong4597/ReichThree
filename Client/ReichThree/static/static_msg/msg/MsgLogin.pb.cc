...
const ::google::protobuf::Descriptor* MsgBlackAccountC2S_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  MsgBlackAccountC2S_reflection_ = NULL;
...
void protobuf_AssignDesc_MsgLogin_2eproto() {
  ...
  MsgBlackAccountC2S_descriptor_ = file->message_type(27);
  static const int MsgBlackAccountC2S_offsets_[4] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MsgBlackAccountC2S, msgtype_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MsgBlackAccountC2S, iggid_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MsgBlackAccountC2S, black_iggid_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MsgBlackAccountC2S, black_),
  };
  MsgBlackAccountC2S_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      MsgBlackAccountC2S_descriptor_,
      MsgBlackAccountC2S::default_instance_,
      MsgBlackAccountC2S_offsets_,
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MsgBlackAccountC2S, _has_bits_[0]),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(MsgBlackAccountC2S, _unknown_fields_),
      -1,
      ::google::protobuf::DescriptorPool::generated_pool(),
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(MsgBlackAccountC2S));
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
    MsgBlackAccountC2S_descriptor_, &MsgBlackAccountC2S::default_instance());
}
...
void protobuf_ShutdownFile_MsgLogin_2eproto() {
  ...
  delete MsgBlackAccountC2S::default_instance_;
  delete MsgBlackAccountC2S_reflection_;
}
...
void protobuf_AddDesc_MsgLogin_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "d\030\002 \001(\003\"\201\001\n\022MsgBlackAccountC2S\0228\n\007msgTyp"
    "e\030\001 \001(\0162\017.MsgPB.EMsgType:\026_MSG_BLACK_ACC"
    "OUNT_C2S\022\r\n\005iggid\030\002 \001(\003\022\023\n\013black_iggid\030\003"
    " \001(\003\022\r\n\005black\030\004 \001(\005*0\n\025LOGIN_QUEUE_UP_AC"
    "TION\022\027\n\023LOGIN_QUEUE_UP_INFO\020\001", 4509);
  ...
  MsgBlackAccountC2S::default_instance_ = new MsgBlackAccountC2S();
  ...
  MsgBlackAccountC2S::default_instance_->InitAsDefaultInstance();
...
#ifndef _MSC_VER
const int MsgBlackAccountC2S::kMsgTypeFieldNumber;
const int MsgBlackAccountC2S::kIggidFieldNumber;
const int MsgBlackAccountC2S::kBlackIggidFieldNumber;
const int MsgBlackAccountC2S::kBlackFieldNumber;
#endif  // !_MSC_VER

MsgBlackAccountC2S::MsgBlackAccountC2S()
  : ::google::protobuf::Message() {
  SharedCtor();
  // @@protoc_insertion_point(constructor:MsgPB.MsgBlackAccountC2S)
}

void MsgBlackAccountC2S::InitAsDefaultInstance() {
}

MsgBlackAccountC2S::MsgBlackAccountC2S(const MsgBlackAccountC2S& from)
  : ::google::protobuf::Message() {
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:MsgPB.MsgBlackAccountC2S)
}

void MsgBlackAccountC2S::SharedCtor() {
  _cached_size_ = 0;
  msgtype_ = 1144;
  iggid_ = GOOGLE_LONGLONG(0);
  black_iggid_ = GOOGLE_LONGLONG(0);
  black_ = 0;
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
}

MsgBlackAccountC2S::~MsgBlackAccountC2S() {
  // @@protoc_insertion_point(destructor:MsgPB.MsgBlackAccountC2S)
  SharedDtor();
}

void MsgBlackAccountC2S::SharedDtor() {
  if (this != default_instance_) {
  }
}

void MsgBlackAccountC2S::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const ::google::protobuf::Descriptor* MsgBlackAccountC2S::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return MsgBlackAccountC2S_descriptor_;
}

const MsgBlackAccountC2S& MsgBlackAccountC2S::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_MsgLogin_2eproto();
  return *default_instance_;
}

MsgBlackAccountC2S* MsgBlackAccountC2S::default_instance_ = NULL;

MsgBlackAccountC2S* MsgBlackAccountC2S::New() const {
  return new MsgBlackAccountC2S;
}

void MsgBlackAccountC2S::Clear() {
#define OFFSET_OF_FIELD_(f) (reinterpret_cast<char*>(      \
  &reinterpret_cast<MsgBlackAccountC2S*>(16)->f) - \
   reinterpret_cast<char*>(16))
...
bool MsgBlackAccountC2S::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
  // @@protoc_insertion_point(parse_start:MsgPB.MsgBlackAccountC2S)
  for (;;) {
    ::std::pair< ::google::protobuf::uint32, bool> p = input->ReadTagWithCutoff(127);
    tag = p.first;
    if (!p.second) goto handle_unusual;
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      // optional .MsgPB.EMsgType msgType = 1 [default = _MSG_BLACK_ACCOUNT_C2S];
      case 1: {
        if (tag == 8) {
          int value;
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
      ...
      case 2: {
        ...
        if (input->ExpectTag(24)) goto parse_black_iggid;
        break;
      }

      // optional int64 black_iggid = 3;
      case 3: {
        if (tag == 24) {
         parse_black_iggid:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
        ...
        if (input->ExpectTag(32)) goto parse_black;
        break;
      }

      // optional int32 black = 4;
      case 4: {
        if (tag == 32) {
         parse_black:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
...
success:
  // @@protoc_insertion_point(parse_success:MsgPB.MsgBlackAccountC2S)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:MsgPB.MsgBlackAccountC2S)
  return false;
#undef DO_
}

void MsgBlackAccountC2S::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:MsgPB.MsgBlackAccountC2S)
  // optional .MsgPB.EMsgType msgType = 1 [default = _MSG_BLACK_ACCOUNT_C2S];
  if (has_msgtype()) {
    ::google::protobuf::internal::WireFormatLite::WriteEnum(
      1, this->msgtype(), output);
  ...
  // optional int64 black_iggid = 3;
  if (has_black_iggid()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt64(3, this->black_iggid(), output);
  }

  // optional int32 black = 4;
  if (has_black()) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(4, this->black(), output);
  }
  ...
  // @@protoc_insertion_point(serialize_end:MsgPB.MsgBlackAccountC2S)
}

::google::protobuf::uint8* MsgBlackAccountC2S::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:MsgPB.MsgBlackAccountC2S)
  // optional .MsgPB.EMsgType msgType = 1 [default = _MSG_BLACK_ACCOUNT_C2S];
  if (has_msgtype()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteEnumToArray(
      1, this->msgtype(), target);
  ...
  // optional int64 black_iggid = 3;
  if (has_black_iggid()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt64ToArray(3, this->black_iggid(), target);
  }

  // optional int32 black = 4;
  if (has_black()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(4, this->black(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:MsgPB.MsgBlackAccountC2S)
  return target;
}

int MsgBlackAccountC2S::ByteSize() const {
  int total_size = 0;
...
void MsgBlackAccountC2S::MergeFrom(const ::google::protobuf::Message& from) {
  GOOGLE_CHECK_NE(&from, this);
  const MsgBlackAccountC2S* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const MsgBlackAccountC2S*>(
      &from);
  if (source == NULL) {
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
...
void MsgBlackAccountC2S::MergeFrom(const MsgBlackAccountC2S& from) {
  GOOGLE_CHECK_NE(&from, this);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_msgtype()) {
      set_msgtype(from.msgtype());
    ...
    if (from.has_black_iggid()) {
      set_black_iggid(from.black_iggid());
    }
    if (from.has_black()) {
...
void MsgBlackAccountC2S::CopyFrom(const ::google::protobuf::Message& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void MsgBlackAccountC2S::CopyFrom(const MsgBlackAccountC2S& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool MsgBlackAccountC2S::IsInitialized() const {

  return true;
}

void MsgBlackAccountC2S::Swap(MsgBlackAccountC2S* other) {
  if (other != this) {
    std::swap(msgtype_, other->msgtype_);
    std::swap(iggid_, other->iggid_);
    std::swap(black_iggid_, other->black_iggid_);
...
::google::protobuf::Metadata MsgBlackAccountC2S::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = MsgBlackAccountC2S_descriptor_;
  metadata.reflection = MsgBlackAccountC2S_reflection_;
  return metadata;
}
