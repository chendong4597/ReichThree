...
class MsgBlackAccountC2S : public ::google::protobuf::Message {
 public:
  MsgBlackAccountC2S();
  virtual ~MsgBlackAccountC2S();

  MsgBlackAccountC2S(const MsgBlackAccountC2S& from);

  inline MsgBlackAccountC2S& operator=(const MsgBlackAccountC2S& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const MsgBlackAccountC2S& default_instance();

  void Swap(MsgBlackAccountC2S* other);

  // implements Message ----------------------------------------------

  MsgBlackAccountC2S* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const MsgBlackAccountC2S& from);
  void MergeFrom(const MsgBlackAccountC2S& from);
  void Clear();
  bool IsInitialized() const;
  ...
  inline bool has_black_iggid() const;
  inline void clear_black_iggid();
  static const int kBlackIggidFieldNumber = 3;
  inline ::google::protobuf::int64 black_iggid() const;
  inline void set_black_iggid(::google::protobuf::int64 value);

  // optional int32 black = 4;
  inline bool has_black() const;
  inline void clear_black();
  static const int kBlackFieldNumber = 4;
  inline ::google::protobuf::int32 black() const;
  inline void set_black(::google::protobuf::int32 value);

  // @@protoc_insertion_point(class_scope:MsgPB.MsgBlackAccountC2S)
 private:
  inline void set_has_msgtype();
  inline void clear_has_msgtype();
  inline void set_has_iggid();
  inline void clear_has_iggid();
  inline void set_has_black_iggid();
  inline void clear_has_black_iggid();
  ...
  ::google::protobuf::int64 iggid_;
  int msgtype_;
  ::google::protobuf::int32 black_;
  ::google::protobuf::int64 black_iggid_;
  friend void  protobuf_AddDesc_MsgLogin_2eproto();
  friend void protobuf_AssignDesc_MsgLogin_2eproto();
  friend void protobuf_ShutdownFile_MsgLogin_2eproto();

  void InitAsDefaultInstance();
  static MsgBlackAccountC2S* default_instance_;
};
// ===================================================================
...
// optional .MsgPB.EMsgType msgType = 1 [default = _MSG_BLACK_ACCOUNT_C2S];
inline bool MsgBlackAccountC2S::has_msgtype() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void MsgBlackAccountC2S::set_has_msgtype() {
  _has_bits_[0] |= 0x00000001u;
}
inline void MsgBlackAccountC2S::clear_has_msgtype() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void MsgBlackAccountC2S::clear_msgtype() {
  msgtype_ = 1144;
  clear_has_msgtype();
}
inline ::MsgPB::EMsgType MsgBlackAccountC2S::msgtype() const {
  // @@protoc_insertion_point(field_get:MsgPB.MsgBlackAccountC2S.msgType)
  return static_cast< ::MsgPB::EMsgType >(msgtype_);
}
inline void MsgBlackAccountC2S::set_msgtype(::MsgPB::EMsgType value) {
  assert(::MsgPB::EMsgType_IsValid(value));
  set_has_msgtype();
  msgtype_ = value;
  // @@protoc_insertion_point(field_set:MsgPB.MsgBlackAccountC2S.msgType)
}

// optional int64 iggid = 2;
inline bool MsgBlackAccountC2S::has_iggid() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void MsgBlackAccountC2S::set_has_iggid() {
  _has_bits_[0] |= 0x00000002u;
}
inline void MsgBlackAccountC2S::clear_has_iggid() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void MsgBlackAccountC2S::clear_iggid() {
  iggid_ = GOOGLE_LONGLONG(0);
  clear_has_iggid();
}
inline ::google::protobuf::int64 MsgBlackAccountC2S::iggid() const {
  // @@protoc_insertion_point(field_get:MsgPB.MsgBlackAccountC2S.iggid)
  return iggid_;
}
inline void MsgBlackAccountC2S::set_iggid(::google::protobuf::int64 value) {
  set_has_iggid();
  iggid_ = value;
  // @@protoc_insertion_point(field_set:MsgPB.MsgBlackAccountC2S.iggid)
}

// optional int64 black_iggid = 3;
inline bool MsgBlackAccountC2S::has_black_iggid() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void MsgBlackAccountC2S::set_has_black_iggid() {
  _has_bits_[0] |= 0x00000004u;
}
inline void MsgBlackAccountC2S::clear_has_black_iggid() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void MsgBlackAccountC2S::clear_black_iggid() {
  black_iggid_ = GOOGLE_LONGLONG(0);
  clear_has_black_iggid();
}
inline ::google::protobuf::int64 MsgBlackAccountC2S::black_iggid() const {
  // @@protoc_insertion_point(field_get:MsgPB.MsgBlackAccountC2S.black_iggid)
  return black_iggid_;
}
inline void MsgBlackAccountC2S::set_black_iggid(::google::protobuf::int64 value) {
  set_has_black_iggid();
  black_iggid_ = value;
  // @@protoc_insertion_point(field_set:MsgPB.MsgBlackAccountC2S.black_iggid)
}

// optional int32 black = 4;
inline bool MsgBlackAccountC2S::has_black() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void MsgBlackAccountC2S::set_has_black() {
  _has_bits_[0] |= 0x00000008u;
}
inline void MsgBlackAccountC2S::clear_has_black() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void MsgBlackAccountC2S::clear_black() {
  black_ = 0;
  clear_has_black();
}
inline ::google::protobuf::int32 MsgBlackAccountC2S::black() const {
  // @@protoc_insertion_point(field_get:MsgPB.MsgBlackAccountC2S.black)
  return black_;
}
inline void MsgBlackAccountC2S::set_black(::google::protobuf::int32 value) {
  set_has_black();
  black_ = value;
  // @@protoc_insertion_point(field_set:MsgPB.MsgBlackAccountC2S.black)
}
