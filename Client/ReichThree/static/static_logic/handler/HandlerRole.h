...
private:
	...
	void onMsgPassiveSkillEffectDmgMS2C(const MsgPB::MsgPassiveSkillEffectDmgMS2C& msg);
	...
	void onMsgDonateS2C(const MsgPB::MsgDonateS2C& msg);
	void onMsgRankS2C(const MsgPB::MsgRankS2C& msg);
	void onMsgArmyAssistS2C(const MsgPB::MsgArmyAssistS2C& msg);
	void onMsgConvoyS2C(const MsgPB::MsgConvoyS2C& msg);
	void onMsgConvoyRecallS2C(const MsgPB::MsgConvoyRecallS2C& msg);
	void onMsgConvoyListS2C(const MsgPB::MsgConvoyListS2C& msg);
	void onMsgConvoyRobberyS2C(const MsgPB::MsgConvoyRobberyS2C& msg);
