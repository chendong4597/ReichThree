...
namespace MsgPB
{
	...
	class MsgProtectorUpgradeStarS2C;
	class MsgDunReviveNpcS2C;
}
...
public:
	...
	void onMsgDunReviveNpcS2C(const MsgPB::MsgDunReviveNpcS2C& msg);
...
private:
	...
	void onMsgProtectorTradeS2C(const MsgPB::MsgProtectorTradeS2C& msg);
	void onMsgProtectorTradeRecallS2C(const MsgPB::MsgProtectorTradeRecallS2C& msg);
	void onMsgProtectorTradeInfoS2C(const MsgPB::MsgProtectorTradeInfoS2C& msg);
	void onMsgProtectorTradeBuyS2C(const MsgPB::MsgProtectorTradeBuyS2C& msg);
	void onMsgProtectorTradeSellS2C(const MsgPB::MsgProtectorTradeSellS2C& msg);
	void onMsgProtectorTradePriceGetS2C(const MsgPB::MsgProtectorTradePriceGetS2C& msg);
	void onMsgTradeNpcAppearance(const MsgPB::MsgTradeNpcAppearance& msg);
	void onMsgProtectorUpgradeStarS2C(const MsgPB::MsgProtectorUpgradeStarS2C& msg);
