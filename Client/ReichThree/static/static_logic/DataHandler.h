...
class HandlerRankEvent : public DataEvent
{
public:
	enum class EventType
	{
...
class HandlerTradeEvent : public DataEvent
{
public:
	enum class EventType
	{
		...
		EventType_My_Buy,
		EventType_My_Sell,
		EventType_UpdateTrades,
		EventType_GuidPrice,
	};

public:
	HandlerTradeEvent() {};
	virtual ~HandlerTradeEvent() {};
...
class HandlerConvoyEvent : public DataEvent
{
public:
	enum class EventType
	{
		Unknown = 0,
		EventType_Convoy_Begin,
		EventType_Convoy_Info,
		EventType_Convoy_List,
		EventType_Convoy_Bat
	};

public:
	HandlerConvoyEvent() {};
	virtual ~HandlerConvoyEvent() {};

public:
	EventType m_type{ EventType::Unknown };
	NS::I64 iggid{ 0 };
	NS::I64 uuid{ 0 };
	NS::int32 nConvoyId{ 0 };
	int nResult{ 0 };
};

//NPC
class HandlerGuardEvent : public DataEvent
{
public:
	enum class EventType
	{
		EventType_Null = 0,
		EventType_Appearance,
		EventType_DisAppearance,
	};
public:
	HandlerGuardEvent() {};
	virtual ~HandlerGuardEvent() {};
...
public:
	...
	int defId{};
	bool bSolider{ false };
	EventType m_type{ EventType::EventType_Null };
};
...
public:
	...
	DECLARE_D_MYEVENT_POST(HandlerRankEvent);
	DECLARE_D_MYEVENT_POST(HandlerTradeEvent);
	DECLARE_D_MYEVENT_POST(HandlerConvoyEvent);
	DECLARE_D_MYEVENT_POST(HandlerGuardEvent);
	...
	DECLARE_D_MYEVENT_POST(MsgDonateS2C);
	DECLARE_D_MYEVENT_POST(MsgArmyAssistS2C);

	DECLARE_D_MYEVENT_POST(MsgPlayerSetAvatorResultS2C);

	DECLARE_D_MYEVENT_POST(MsgProtectorUpgradeStarS2C);

	DECLARE_D_MYEVENT_POST(MsgSurvivalNotifyEventS2C);
	DECLARE_D_MYEVENT_POST(MsgDunReviveNpcS2C);

	DECLARE_D_MYEVENT_POST(MsgItemEquipAttrWashS2C);
	DECLARE_D_MYEVENT_POST(MsgItemEquipAttrSaveS2C);
	...
	DECLARE_D_MYEVENT_POST(MsgPassiveSkillEffectDmgMS2C);
